...
/// Screen for selecting language to start output prediction challenges.
class OutputHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(AppStrings.outputPredictor),
              ...
              child: Column(
                ...
                children: [
                  ...
                  FittedBox(
                    ...
                    child: Text('$title Output Prediction', style: AppTextStyles.caption),
                  ),
                ],
              ),
            ),
